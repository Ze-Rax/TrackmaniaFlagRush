...
An explanation on how to create map for the FlagRush gamemode can be found in the [Mapping guide](./Documentation/Mapping%20guide.md).
...
3. Place the contents of `DedicatedServer` folder into your dedicated server's `UserData` folder.
	...
	- The gamemode behaviour can be customized with settings that are applied through the match settings file, see [Mode settings documentation](./Documentation/Mode%20settings.md).
4. Start the server:
